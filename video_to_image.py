...
def split_frame(file, path):
    ...
    if not os.path.exists(path):
        os.mkdir(path)
    # 视频逐帧转换为图片
    os.system('ffmpeg -i {} -r 25  -f image2 {}/%03\d.jpg'.format(file, path))
    tmp = os.listdir(path)
...
root = '/Users/zcyyy/Documents/硕士学习/临时/dataset/AFEW/Train_AFEW'
...
# ffprobe -v error -count_frames -select_streams v:0 -show_entries stream=nb_read_frames -of default=nokey=1:noprint_wrappers=1 000223480.avi'
# 上面是测试总帧数的指令